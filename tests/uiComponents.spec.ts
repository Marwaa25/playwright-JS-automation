import { BoxChartComponent, CardComponent } from '@swimlane/ngx-charts'
...
test.describe('Form Layouts pages @block' , () => {
    ...
    test.only('radio buttons', async({page}) => {
        ...
        //byLabel
        // await usingTheGridForm.getByLabel('Option 1').check({force: true}) // we used force because in the code Option 1 is visually hidden and playwright cannot check it
...
test('checkboxes', async({page}) => {
    ...
    // we use the loop to loop through the list of the elements or through the list of checkboxes
    // we use the method all() to create an array
...
test('lists and dropdowns', async({page}) =>{
    ...
    //we ll use the locator cause this app doesn't have items
